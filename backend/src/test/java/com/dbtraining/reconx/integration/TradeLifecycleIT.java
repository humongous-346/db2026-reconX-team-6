...
/**
 * TICKET-ADV078 — full trade lifecycle over real HTTP against a
 * Testcontainers-backed Postgres: login, create, list, patch status,
 * trigger recon, resolve a break.
 */
@Testcontainers
...
class TradeLifecycleIT {
    ...
    @Test @Order(6)
    void resolveBreak() {
        // recon_breaks has no Liquibase seed data — insert one directly so
        // there is a known, open break to resolve over HTTP.
